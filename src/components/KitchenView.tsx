                            ...
                            >
                                    ...
                                    <div className="flex justify-between items-center w-full">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="flex items-center gap-1 px-2 py-1 rounded-md font-bold text-3xl bg-background border">
                                                ...
                                                {Math.max(0, Math.floor(timeDiff))}'
                                            </div>
                                        </div>
                                    </div>
                                </CardHeader>
                                ...
                                <CardContent className="flex-1 p-3 flex flex-col gap-2">
                                    {(() => {
                                        ...
                                        const itemsByCourse: { [key: number]: typeof visibleItems } = {}
                                        ...
                                        return courseNumbers.map((courseNum, courseIdx) => (
                                            <div key={courseNum}>
                                                {/* Course separator */}
                                                {hasMultipleCourses && (
                                                    <div className={cn(
                                                ...
                                                {itemsByCourse[courseNum].map((item, idx) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={`${item.id}-${idx}`}
                                                            className={cn(
                                                                "flex items-center justify-between p-2 rounded-md border transition-all mb-2",
                                                                isItemDone
                                                ...
                                                {hasMultipleCourses && courseIdx < courseNumbers.length - 1 && (
                                                    <div className="my-3 border-t-4 border-dashed border-slate-600/50" />
                                                )}
                                            </div>
                                        ))
                                    })()}
