                                ...
                                <PopoverContent className="w-auto p-2" align="end" onClick={(e) => e.stopPropagation()}>
                                  <div className="flex flex-col gap-1">
                                    ...
                                    <Button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation()
                                        handlePostponeBooking(block.booking, 15)
                                      }}
                                    >
                                    ...
                                    <Button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation()
                                        handlePostponeBooking(block.booking, 30)
                                      }}
                                    >
                                    ...
                                    <Button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation()
                                        handlePostponeBooking(block.booking, 60)
                                      }}
                                    >
                                      <ArrowRight size={12} className="mr-1" /> +1 ora
                                    </Button>
                                  </div>
                                </PopoverContent>
                              </Popover>
