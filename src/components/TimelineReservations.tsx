                    ...
                    .map((block, i) => {
                      ...
                      return (
                        <div
                          ...
                          className={`absolute top-2 bottom-2 rounded-md px-2 py-1 text-xs font-medium overflow-hidden whitespace-nowrap shadow-sm border cursor-pointer hover:brightness-95 transition-all z-10 ${isCompleted ? 'bg-green-100 text-green-800 border-green-200 opacity-60' : 'bg-primary/10 text-primary border-primary/20'}`}
                        ...
                        >
                          <div className="font-bold truncate">{block.booking.name}</div>
                          <div className="truncate opacity-80">{block.booking.guests} pers.</div>
                        </div>
                      )
                    })}
                </div>
