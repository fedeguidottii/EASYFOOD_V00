          ...
          <div className="flex-1 overflow-y-auto p-6 pt-2 space-y-6">
            ...
            {cartItems.length > 0 && (
              <div className="space-y-4">
                <h3 className="font-semibold text-sm text-muted-foreground uppercase tracking-wider">Da Ordinare</h3>
                {cartItems.map(item => {
                  const dish = dishes.find(d => d.id === item.dish_id)
                  if (!dish) return null
                  return (
            ...
            {orders.length > 0 && (
              <div className="space-y-4">
                <h3 className="font-semibold text-sm text-muted-foreground uppercase tracking-wider">Inviati alla Cucina</h3>
                {orders.map(order => (
